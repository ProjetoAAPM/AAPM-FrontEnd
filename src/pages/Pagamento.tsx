    ...
    return (
        <div className="min-h-[100vh] bg-[#101625] flex flex-col items-center py-5">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-10 lg:gap-20 w-full mb-15 mt-23 md:mt-25 lg:mt-37 justify-between">
                ...
                >
                    <p className="bg-[#86D5FE]/80 rounded-md p-6 mx-6 lg:-mt-32 text-sm md:text-xl lg:text-[22px]"> 
                ...
                >
                    <p className="bg-[#EFC10E]/80 rounded-md p-4 mx-6 lg:-mt-2 text-sm md:text-xl lg:text-[22px] "> 
