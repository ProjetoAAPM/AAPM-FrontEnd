...
function EscolhaPlano() {
    ...
    const handleConfirmarEnvio = async () => {
        ...
        if (!idUsuarioSalvo) {
            alert(
                "Erro crítico: O ID do usuário não foi encontrado na memória do navegador! Refaça o cadastro."
            );
            return;
        }
        ...
        const dadosPagamento = {
            ...
            valor: planoSelecionado === "premium" ? 100.0 : 50.0,
        };
        ...
        try {
            ...
            const respostaEtapa1 = await fetch(
                "http://localhost:5000/pagamento/gerar",
                {
                    method: "POST",
                    headers: {
            ...
            const idPagamento =
                resultadoEtapa1.id_pagamento ||
                resultadoEtapa1.id;

            if (!idPagamento) {
                alert("Erro: pagamento sem ID retornado.");
            ...
            const resultadoEtapa2 =
                await respostaEtapa2.json();
        ...
        /* try {
            ...
            const idPagamento =
                resultadoEtapa1.id_pagamento || resultadoEtapa1.id;
            ...
            alert(
                "Não foi possível conectar ao servidor. Certifique-se de que o backend está ativo."
            );
        ...
        <div className="min-h-[100vh] bg-[#101625] flex flex-col items-center py-5 ">
            ...
            <div className="flex flex-wrap justify-center gap-8 w-full mb-15 justify-between">
                <CardPlano
                    ...
                    popular={false}
                    textoBtn={
                        loading && planoSelecionado === "comum"
                            ? "Enviando..."
                            : "Upload"
                    }
                    corBtn="bg-[#373737] text-white"
                    onClick={() =>
                        handlPrepararEnvio("comum", comprovanteComum)
                    }
                >
                    <img
                    ...
                    <Copiador textoParaCopiar="https://www.sp.senai.br/">
                        <div className="w-full max-w-[260px] md:max-w-[299px] h-[50px] bg-[#78C0E5] p-2 mt-3 rounded-lg flex items-center justify-between border-2 border-[#78C0E5] shadow-md cursor-pointer">
                            <div className="text-left overflow-hidden">
                                ...
                                <p className="text-sm md:text-sm font-semibold text-[#FFFFFF] truncate">
                ...
                <CardPlano
                    ...
                    popular={true}
                    textoBtn={
                        loading && planoSelecionado === "premium"
                            ? "Enviando..."
                            : "Upload"
                    }
                    corBtn="bg-[#86D5FE]"
                    onClick={() =>
                        handlPrepararEnvio("premium", comprovantePremium)
                    }
                >
                    <img
                        src="src/assets/images/qrcode.png"
                    ...
                    <Copiador textoParaCopiar="https://www.sp.senai.br/">
                        <div className="w-full max-w-[260px] md:max-w-[299px] h-[50px] bg-[#424242] p-2 mt-3 rounded-lg flex items-center justify-between shadow-md cursor-pointer">
                            <div className="text-left overflow-hidden">
                                <p className="text-xs md:text-xs font-medium text-[#F0C72B]">
                                    Chave Pix
                                </p>
                            ...
                            <Copy
                                size={16}
                                className="text-[#F0C72B] flex-shrink-0 ml-2"
                            />
                        </div>
                    </Copiador>
