        ...
        <div className="min-h-[100vh] bg-[#101625] flex flex-col items-center py-5 ">
           ...
           <div className="w-full max-w-5xl mb-5">
                ...
                <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] bg-[#42B9F4] py-4 -mt-8 -mb-4 md:-mt-5 md:mb-2 lg:-mt-1 lg:mb-3 lg:h-[80px]">
                    <h1 className="text-white text-center text-2xl md:text-3xl lg:text-4xl font-bold italic">
                        Escolha o seu plano
                    </h1>
                </div>
           </div>
           ...
           <div className="flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-8 w-full mb-15 justify-between">
                ...
                > 
                    ...
                    <Copiador textoParaCopiar="https://www.sp.senai.br/">
                            <div className="w-full max-w-[260px] md:max-w-[280px] h-[50px] bg-[#78C0E5] p-2 mt-3 rounded-lg flex items-center justify-between border-2 border-[#78C0E5] shadow-md cursor-pointer">
                        ...
                        <label className={`w-[90%] max-w-[300px] min-h-[120px] lg:max-w-[400px] lg:min-h-[160px] mt-3 mb-3 rounded-sm bg-[#F5F5F5] flex flex-col items-center justify-center cursor-pointer`}
                ...
                > 
                    ...
                    <Copiador textoParaCopiar="https://www.sp.senai.br/">
                        ...
                        <label className={`w-[90%] max-w-[300px] min-h-[120px] lg:max-w-[400px] lg:min-h-[160px] mt-3 mb-3 rounded-sm bg-[#F5F5F5] flex flex-col items-center justify-center p-2 cursor-pointer`}
                            onDragOver={(e) => e.preventDefault()}
                            onDrop={(e) => {
                                e.preventDefault();
                                const file = e.dataTransfer.files[0];
