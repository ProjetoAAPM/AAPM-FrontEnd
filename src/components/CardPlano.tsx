    ...
    return (
        <div className={`relative w-full max-w-[435px] h-auto lg:min-h-[619px] mt-10 ${popular ? 'scale-100 lg:scale-105' : ''}`}>
            ...
            <div className={`w-full h-full lg:min-h-[619px] flex flex-col items-center text-center shadow-lg relative z-10 rounded-2xl
                ...
                {popular && (
                    <div className="absolute w-[90%] max-w-[270px] h-[45px] -top-6 left-1/2 -translate-x-1/2 bg-linear-to-r from-[#F1D052] via-[#FFEFAF] to-[#F0C72B] rounded-full shadow-md flex justify-center items-center gap-2 z-20">
                        <Star size={24} className="text-[#BE9700]" fill="currentColor"/>
                        <h3 className="text-xl md:text-xl font-bold text-[#332900]">MAIS POPULAR</h3>
                    </div>
                )}

                <div className={`${fundoTitulo} flex items-center justify-center mb-4 `}>
                    <h3 className="text-2xl md:text-3xl font-bold mt-4 mb-4 text-black">
                        {titulo}
                    </h3>
                </div>
                ...
                <div className=" flex flex-col grow w-full">
                    ...
                    <button onClick={onClick} className={`${corBtn} w-full max-w-[180px] mx-auto h-[54px] rounded-xl font-bold shadow-md hover:scale-105 active:scale-95 transtion-all mb-4 text-2xl cursor-pointer`}>
                        { textoBtn || "Contribuir"}
                    </button>
                </div>
            </div>
