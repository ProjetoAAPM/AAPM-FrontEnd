...
export default function PorcoPorcentagem({
  ...
  return (
    <div className="relative flex items-center justify-center w-full mt-20 min-[350px]:mt-35 sm:mt-25 md:mt-6 lg:mt-2">
      {animar && (
        <>
          <img src={moeda} alt="Moeda" className="absolute top-[-80px] left-[46%] w-9 sm:w-12 md:w-14 z-20 moeda-caindo" />
          <img src={moeda} alt="Moeda" className="absolute top-[-120px] left-[52%] w-8 sm:w-10 md:w-12 z-20 moeda-caindo" style={{ animationDelay: "0.15s" }} />
          <img src={moeda} alt="Moeda" className="absolute top-[-100px] left-[42%] w-7 sm:w-9 md:w-11 z-20 moeda-caindo" style={{ animationDelay: "0.3s" }} />
        </>
      )}
