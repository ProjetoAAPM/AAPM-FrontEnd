...
export default function Sugestoes({
    ...
    function enviarSugestao() {
        ...
        const ultimaSugestao = localStorage.getItem(
            "ultimaSugestao"
        );
        ...
        if (ultimaSugestao === hoje) {
            ...
            alert(
                "Você já enviou uma sugestão hoje. Mande novamente amanhã!"
            );
