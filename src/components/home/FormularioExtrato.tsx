        ...
        <div className="w-full max-w-[1890px] mx-auto px-3 sm:px-4 md:px-6 mt-2">
            <div className="flex flex-col lg:flex-row gap-3 lg:h-[93vh]">
                ...
                <div className={`bg-[#DDF4FF] ${modoAdmin ? "w-full" : "w-full lg:w-3/4"} h-[93vh] rounded-[15px] shadow-2xl flex flex-col px-3 sm:px-5 md:px-10 py-6 relative overflow-hidden`}>
                    ...
                    <div className="absolute top-8 left-0 bg-white text-[#101625] text-[1.5rem] sm:text-[2rem] md:text-[3rem] font-black px-20 sm:px-32 md:px-[280px] lg:px-[400px] xl:px-[600px] py-1 rounded-r-[10px] shadow-md z-10 flex items-center justify-center max-w-[90%]">
                        Formulários
                    </div>
                    ...
                    {modoAdmin && (
                        <button
                            ...
                            className="absolute top-21 md:top-31 right-3 sm:right-6 md:right-10 z-20 bg-[#C83D3D] text-white rounded-full px-4 sm:px-6 md:px-8 py-2 sm:py-3 font-bold hover:brightness-95 transition-all whitespace-nowrap"
                        >
                            {mostrarFormulario ? "Cancelar" : "Criar formulário"}
                        </button>
                    )}

                    <div className={`mt-[110px] md:mt-[160px] bg-white rounded-[12px] shadow-md w-full max-w-[95%] sm:max-w-[800px] md:max-w-[1100px] lg:max-w-[1300px] mx-auto ${
                        modoAdmin
                        ...
                        <div className="h-full overflow-y-auto scroll-modern px-2 py-5">
                            <div className="flex flex-col gap-6">
                                ...
                                {formulariosSalvos.length === 0 && !mostrarFormulario && (
                                    <div className="py-[180px] flex items-center justify-center text-gray-500 font-semibold text-center px-4">
                    ...
                    <div className="bg-[#BBE1FE] w-full lg:w-1/4 h-[93vh] rounded-[15px] shadow-2xl p-3 sm:p-4 relative flex flex-col overflow-hidden">
                        ...
                        <div className="mt-[110px] flex-1 overflow-y-auto scroll-modern pr-2">
                            <div className="p-2 space-y-3">
                                ...
                                {extrato.map((item, i) => (
                                    <div key={i} className="bg-white rounded-[8px] p-3 shadow-sm flex justify-between items-center">
