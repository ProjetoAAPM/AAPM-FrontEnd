...
export default function FormularioExtrato({ modoAdmin = false, extrato }: FormularioExtratoProps) {
    ...
    const excluirFormulario = (id: number) => {
        const novaLista = formulariosSalvos.filter((formulario) => formulario.id !== id);
        ...
        <div className="w-full max-w-[1890px] mx-auto px-3 sm:px-4 md:px-6 mt-2">
            <div className="flex flex-col lg:flex-row gap-3 lg:h-[93vh]">
                <div className={`bg-[#DDF4FF] ${modoAdmin ? "w-full" : "w-full lg:w-3/4"} h-[93vh] rounded-[15px] shadow-2xl flex flex-col px-3 sm:px-5 md:px-10 py-6 relative overflow-hidden`}>
                    ...
                    <div className={`mt-[110px] md:mt-[160px] [@media(min-width:1330px)]:mt-[200px] [@media(min-width:1600px)]:mt-[110px] bg-white rounded-[12px] shadow-md w-full max-w-[95%] sm:max-w-[800px] md:max-w-[1100px] lg:max-w-[1300px] mx-auto ${modoAdmin ? "min-h-[400px] sm:h-[240px] md:h-[320px] lg:h-[450px]" : "min-h-[400px] sm:h-[220px] md:h-[280px] lg:h-[350px]"} overflow-hidden`}>
