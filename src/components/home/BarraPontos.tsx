...
export default function BarraPontos({
  ...
  return (
    ...
    <div className="relative w-full max-w-[1610px] mx-auto bg-[#383636]/90 backdrop-blur-md rounded-full px-2 py-2 sm:p-4 md:p-5 mt-4 overflow-hidden">
      {showGlass && (
      ...
      <div className="relative w-full bg-[#D3D3D3] rounded-full h-4 sm:h-6 md:h-7 shadow-[inset_0_2px_6px_rgba(0,0,0,0.3)] overflow-visible">
        ...
        <div
          className={`absolute left-0 top-1/2 -translate-y-1/2 rounded-full transition-all duration-1000 ease-out shadow-lg z-0 h-4 sm:h-6 md:h-7 ${
            ...
            >
              <div className="relative flex items-center justify-center">
                <div
                  ...
                  } ${isCelebrando ? "animate-marco-brilho scale-125 shadow-[0_0_35px_rgba(255,255,255,0.95)] z-[30]" : ""}`}
                  style={
                    isCelebrando
                ...
                >
                  ...
                  {isUltima && (
                    <div className="relative flex gap-[1px] sm:gap-1 group">
                      ...
                      <Star className={`w-2 h-2 sm:w-5 sm:h-5 md:w-7 md:h-7 ${premium ? "text-[#383636] fill-[#383636]" : "text-[#FFDE59] fill-[#FFDE59]"}`} />
