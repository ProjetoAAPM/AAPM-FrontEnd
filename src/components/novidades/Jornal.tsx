...
export default function Jornal() {
  return (
    <div className="w-full min-h-screen bg-[#101625] text-white py-[70px] overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 px-4 sm:px-6 lg:pl-10 lg:pr-10">

        <div className="flex flex-col gap-4">
          <img
            src={img1}
            className="rounded-xl w-full h-[250px] lg:h-[300px] object-cover"
          />
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <p className="text-sm sm:text-base leading-relaxed text-justify w-full lg:max-w-[300px]">
            ...
            <img
              src={img2}
              className="rounded-xl w-full sm:w-[300px] md:h-[160px] h-[260px] object-cover"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <img
            src={img3}
            className="rounded-xl w-full h-[300px] lg:h-[395px] object-cover"
          />
        </div>
        ...
        <div className="flex flex-col gap-4">
          <img
            src={img4}
            className="hidden md:block rounded-xl w-full h-[300px] lg:h-[370px] object-cover"
          />
