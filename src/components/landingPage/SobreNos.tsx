...
function SobreNos() {
  ...
  useEffect(() => {
    ...
    async function carregarDados() {
      ...
      const sFutsal = await buscarImagem("futsal");

      const sGrupo = await buscarImagem("grupo");

      const sText = await buscarConteudo("sobre-texto");
  ...
  const SOBRE_PADRAO = `
    <div class="mb-8 md:mx-20 lg:mx-30 text-white">
      ...
      <p class="leading-relaxed text-gray-200 text-lg md:text-xl lg:text-2xl">
        ...
        a formação dos alunos e 

        <span class="font-semibold text-white">
          oferecer
        </span>

        suporte administrativo e financeiro para atividades que vão além do currículo obrigatório.
      </p>
    </div>
    ...
    <div class="mb-8 md:mx-20 lg:mx-30 text-white">
      ...
      <ul class="list-disc list-inside space-y-3 text-gray-200 text-lg md:text-xl lg:text-2xl">
        ...
        <li>
          ...
          , empréstimo de armários, e acesso a ferramentas de lazer e esportes.
        </li>
