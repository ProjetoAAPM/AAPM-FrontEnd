...
function Inicio() {
  ...
  useEffect(() => {
    const salvo = localStorage.getItem("inicio-texto");
  ...
  const conteudoPadrao = `
    ...
    <p class="text-white text-base md:text-xl lg:text-3xl mt-4 max-w-3xl font-medium">
      Faça parte de projetos que transformam o Senai em<br class="hidden md:block" />um lugar ainda melhor para aprender e crescer
    </p>
        ...
        <div className="flex flex-col items-center md:items-start relative">
          {editMode ? (
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: conteudoSalvo || conteudoPadrao }}
            />
          )}
        </div>
